...
const resources = {
  ...
  ur: {
    translation: {
      header: {
        brandAr: 'امان ایور اور طبی خدمات کی جامع دیکھ بھال',
        brandEn: 'AMAN EVER COMPANY & COMPREHENSIVE Care of Medical Services',
        home: 'ہوم',
        about: 'ہمارے بارے میں',
        services: 'ہماری خدمات',
        features: 'ہماری خصوصیات',
        myBookings: 'میری بکنگز اور طبی مشاورت',
        merchantPlatform: 'مرچنٹ لاگ ان پلیٹ فارم',
        amanDoctor: 'ڈاکٹر لاگ ان پلیٹ فارم',
        blog: 'امان بلاگ',
      ...
      hero: {
        badge: 'امان ایور اور جامع دیکھ بھال',
        slogan: 'آپ کی ضرورت ایک ایپ میں، آپ کی دنیا ایک کارڈ میں',
        slides: [
          {
            title: 'امان ایور اور طبی خدمات کی جامع دیکھ بھال',
            description: 'آپ کی تمام طبی، صحت اور خوبصورتی کی ضروریات ایک پلیٹ فارم میں.. اپنا وقت بچائیں، اور اپنے معیار کی ضمانت دیں۔',
            message: 'پیشہ ورانہ طبی ثالثی اور سمارٹ صحت کے حل۔',
            cta: 'ابھی ایپ ڈاؤن لوڈ کریں اور اپنا صحت کا سفر شروع کریں'
          },
          {
            title: 'آپ کی ضرورت ایک ایپ میں، آپ کی دنیا ایک کارڈ میں',
            description: 'ہمارے مربوط ڈیجیٹل پلیٹ فارم اور سمارٹ الیکٹرانک کارڈ کے ساتھ صحت کی دیکھ بھال کے مستقبل کا تجربہ کریں۔',
            message: 'جدید ڈیجیٹل صحت کے حل جو زندگی کے معیار کو بہتر بناتے ہیں۔',
            cta: 'ابھی امان ایور میں شامل ہوں'
          },
          {
            title: 'اعلیٰ ڈاکٹرز اور 24/7 براہ راست دیکھ بھال',
            description: 'آپ کی حفاظت کے لیے چوبیس گھنٹے اعلیٰ ڈاکٹروں سے ڈیجیٹل خدمات اور براہ راست دیکھ بھال فراہم کرنا۔',
            message: 'آپ اور مملکت میں بہترین طبی فراہم کنندگان کے درمیان پل۔',
            cta: 'اپنا مشاورت ابھی شروع کریں'
          },
          {
            title: 'امان ایور ممبرشپ (پریمیئر اور VIP کارڈز)',
            description: 'تمام طبی اور خوبصورتی کی خدمات پر 80٪ تک براہ راست رعایت حاصل کرنے کا آپ کا گیٹ وے۔ آپ کی صحت ہمارے ساتھ زیادہ قیمتی ہے۔',
            message: 'ایک کارڈ میں شمولیت اور رفتار۔',
            cta: 'ابھی اپنا کارڈ حاصل کریں'
          },
          {
            title: 'وفاداری پروگرام (کیش بیک)',
            description: 'ہر استعمال کے ساتھ اپنے بٹوے میں نقد واپس حاصل کریں۔ صحت جو آپ کو ہر دورے کے ساتھ انعام دیتی ہے۔',
            message: 'بچت جو پہلے دورے سے شروع ہوتی ہے۔',
            cta: 'کیش بیک فوائد دریافت کریں'
          },
          {
            title: 'امان پوائنٹس والیٹ',
            description: 'اپنے طبی بلوں کو پوائنٹس میں تبدیل کریں اور انہیں خصوصی تحائف اور رعایت کے لیے استعمال کریں۔',
            message: 'ہر پوائنٹ انعامات کی دنیا کے برابر ہے۔',
            cta: 'پوائنٹس کی دنیا میں شامل ہوں'
          },
          {
            title: 'امان ایور الیکٹرانک اسٹور',
            description: 'مسابقتی قیمتوں اور خصوصی پیشکشوں پر اعلیٰ معیار کی طبی اور خوبصورتی کی مصنوعات۔',
            message: 'سمارٹ خریداری کریں اور محفوظ طریقے سے ادائیگی کریں۔',
            cta: 'ابھی خریداری کریں'
          }
        ],
        discoverNetwork: 'نیٹ ورک دریافت کریں'
      },
      floating: {
        urgentConsultation: 'فوری مشاورت',
        membershipRequest: 'ممبرشپ کی درخواست'
      },
      // Note: Rest of translations will be added later - using Arabic as placeholder for now
      actions: {
        booking: {
          title: 'طبی ملاقات بک کریں',
          desc: 'آسانی سے ڈاکٹر کے ساتھ اپنی ملاقات بک کریں'
        },
        card: {
          title: 'الیکٹرانک کارڈ',
          desc: 'آپ کا صحت کارڈ ہمیشہ آپ کے ساتھ ہے'
        },
        homeCare: {
          title: 'گھر کی دیکھ بھال',
          desc: 'ہماری طبی خدمات آپ کے گھر تک پہنچتی ہیں'
        }
      },
      features: {
        subtitle: 'ہم بہترین کیوں ہیں؟',
        title: 'مسابقتی فوائد',
        items: [],
        cta: 'ابھی ان تمام خصوصیات سے لطف اندوز ہوں.. امان ایور ایپ ڈاؤن لوڈ کریں',
        servicesTitle: 'ہمارا سروس پیکیج',
        servicesSubtitle: 'آپ کے آرام اور حفاظت کے لیے ڈیزائن کردہ جدید صحت کے حل',
        searchPlaceholder: 'مطلوبہ سروس تلاش کریں...',
        noResults: 'آپ کی تلاش سے کوئی سروس میل نہیں کھاتی',
        showAll: 'تمام خدمات دکھائیں',
        services: [],
        modals: {
          membership: { title: '', content: '', buttons: [] },
          cashback: { title: '', content: '', mechanism: [] },
          points: { title: '', content: '', mechanism: [] },
          bookings: { title: '', content: '', buttons: [] },
          homeCare: { title: '', content: '' },
          store: { title: '', content: '' },
          'medical-network': { title: '', content: '' },
      ...
      about: {
        subtitle: 'ہم کون ہیں؟',
        title: 'دیکھ بھال کے سفر میں آپ کا سمارٹ پارٹنر',
        desc: '',
        identity: { title: 'ہماری شناخت', desc: '' },
        vision: { title: 'ہماری ویژن', desc: '' },
        mission: { title: 'ہمارا مشن', desc: '' }
      },
      network: {
        title: 'امان وسیع نیٹ ورک',
        medicalTab: 'طبی نیٹ ورک',
        healthTab: 'صحت نیٹ ورک',
        medical: [],
        health: []
      },
      nearbyProviders: {
        title: 'آپ کے قریب سروس فراہم کنندگان',
        subtitle: 'اپنے مقام کے ارد گرد بہترین طبی، صحت اور خوبصورتی کی خدمات تلاش کریں',
        categories: {
          all: 'تمام',
          hospitals: 'ہسپتال',
          clinics: 'کلینک',
          pharmacies: 'فارمیسی',
          beauty: 'خوبصورتی کے مراکز'
        },
        viewMap: 'نقشے پر دیکھیں',
        bookNow: 'ابھی بک کریں',
        distance: 'کلومیٹر دور'
      },
      discounts: {
        title: 'مضبوط خصوصی رعایت',
        subtitle: 'صرف امان ایور سبسکرائبرز کے لیے خاص اور خصوصی پیشکشیں',
        viewAll: 'تمام دیکھیں',
        discount: 'رعایت',
        shareSuccess: 'پیشکش کامیابی سے شیئر کی گئی!',
        copySuccess: 'پیشکش کا لنک کلپ بورڈ میں کاپی ہو گیا!',
        shareError: 'معذرت، شیئرنگ مکمل نہیں ہو سکی۔',
        cta: 'ایپ کے ذریعے ابھی پیشکش حاصل کریں'
      },
      nearby: {
        liveCenter: 'لائیو مانیٹرنگ سینٹر',
        title: 'امان لائیو',
        subtitle: 'فوری سمارٹ کوریج',
        unitDistribution: 'یونٹ کی تقسیم',
        activeProviders: 'فعال طبی فراہم کنندگان',
        logsTitle: 'لائیو آپریشنز لاگ',
        searchPlaceholder: 'یونٹ تلاش کریں (ایمبولینس، ہسپتال، ڈاکٹر)...',
        trackingUnits: '{{count}} یونٹس کو ٹریک کر رہے ہیں',
        activeDetection: 'فعال پتہ لگانے کا نظام',
        scanningProtocol: 'مقام پروٹوکول',
        scanningLabels: ['شروع ہو رہا ہے...', 'نیٹ ورک اسکین کر رہے ہیں...', 'ڈیٹا ہم آہنگ کر رہے ہیں...', 'تیار'],
        legend: {
          center: 'طبی مرکز',
          ambulance: 'موبائل ایمبولینس',
          doctor: 'مشیر ڈاکٹر'
        },
        startScan: 'جامع اسکین شروع کریں',
        noResults: 'کوئی نتیجہ نہیں ملا',
        noResultsDesc: 'کسی اور یونٹ کی تلاش کی کوشش کریں',
        detectionSystem: 'پتہ لگانے کا نظام',
        protocolTitle: 'اسکیننگ پروٹوکول',
        fieldLogs: 'فیلڈ لاگز',
        distribution: 'اثاثہ جات کی تقسیم',
        geoNotSupported: 'آپ کا براؤزر جغرافیائی مقام کی حمایت نہیں کرتا',
        geoSuccess: 'مقام کامیابی سے حاصل کیا گیا',
        geoError: 'آپ کا مقام حاصل نہیں کیا جا سکا',
        scanSteps: ['شروع ہو رہا ہے...', 'نیٹ ورک اسکین کر رہے ہیں...', 'ڈیٹا ہم آہنگ کر رہے ہیں...'],
        logs: ['ایمرجنسی کال موصول ہوئی', 'ایمبولینس بھیجی گئی', 'مریض ہسپتال پہنچ گیا'],
        randomLogs: ['یونٹ AE-04 شمال کی طرف جا رہا ہے', 'MC-JED-01 حیثیت: فعال', 'AE-12-RESCUE اسٹینڈ بائی پر', 'AE-PRO-DR مشاورت شروع ہوئی', 'MC-NORTH مینٹیننس چیک']
      },
      blog: {
        title: 'امان بلاگ',
        subtitle: 'تازہ ترین قابل اعتماد صحت کی خبریں اور تجاویز',
        readMore: 'مزید پڑھیں',
        source: 'ذریعہ:',
        posts: []
      },
      faq: {
        ...
        subtitle: 'امان ایور کی خدمات کے بارے میں آپ کو جاننے کی ضرورت ہے',
        moreQuestions: 'کیا آپ کے مزید سوالات ہیں؟',
        contactSupport: 'تکنیکی معاونت سے رابطہ کریں',
        items: []
      },
      footer: {
        desc: 'صحت کی دیکھ بھال میں آپ کا قابل اعتماد پارٹنر۔ ہم آپ اور آپ کے خاندان کو ہماری جدید ایپ کے ذریعے بہترین طبی خدمات فراہم کرتے ہیں۔',
        cr: 'تجارتی رجسٹر: 7038166471',
        quickLinks: 'فوری رسائی',
        links: {
          about: 'امان ایور کے بارے میں',
          services: 'ہماری طبی خدمات',
          features: 'ہماری خصوصیات',
          myBookings: 'میری بکنگز اور طبی مشاورت',
          network: 'طبی اور صحت نیٹ ورک',
          doctorPlatform: 'ڈاکٹر لاگ ان پلیٹ فارم',
          merchantPlatform: 'مرچنٹ پلیٹ فارم',
          homeCare: 'گھر کی دیکھ بھال کی خدمات',
          amanCards: 'امان ایور کارڈز اور پیکجز کے بارے میں',
          privacy: 'رازداری اور ڈیٹا پالیسی'
        },
        contactUs: 'ہم سے رابطہ کریں',
        downloadApp: 'ایپ ڈاؤن لوڈ کریں',
        address: 'جدہ، البغدادیہ الشرقیہ – البغدادیہ پلازہ بلڈنگ',
        customerService: 'کسٹمر سروس نمبر',
        whatsapp: 'واٹس ایپ',
        landline: 'لینڈ لائن',
        rights: '© {{year}} امان ایور کمپنی اور طبی خدمات کی جامع دیکھ بھال۔ تمام حقوق محفوظ ہیں۔',
        terms: 'شرائط و ضوابط',
        dataPolicy: 'ڈیٹا پالیسی',
        privacy: 'رازداری کی پالیسی',
        social: {
          facebook: 'فیس بک پر ہمیں فالو کریں',
          instagram: 'انسٹاگرام پر ہمیں فالو کریں',
          snapchat: 'سنیپ چیٹ پر ہمیں شامل کریں',
          tiktok: 'ٹک ٹاک پر ہمیں فالو کریں',
          x: 'X پر ہمیں فالو کریں',
          linkedin: 'لنکڈ ان پر ہم سے جڑیں',
          youtube: 'ہمارے یوٹیوب چینل کو سبسکرائب کریں'
        }
      },
      bookingsModal: {
        title: 'اعلیٰ ڈاکٹروں کے لیے آپ کی فوری ونڈو',
        description: 'امان ایور بکنگ سسٹم کے ساتھ صحت کی دیکھ بھال کی ایک نئی سطح کا تجربہ کریں۔',
        features: [],
        cta: 'ڈیٹا کی حفاظت کی اعلیٰ سطح کو یقینی بنانے اور آپ کو ہموار بکنگ کا تجربہ فراہم کرنے کے لیے، ہمارا نظام صرف امان ایور ایپ کے ذریعے دستیاب ہے۔',
        mainBtn: 'ہموار بکنگ کے تجربے کے لیے ابھی ایپ ڈاؤن لوڈ کریں'
      },
      doctorPlatform: {
        title: 'امان ڈاکٹر پلیٹ فارم: ٹیکنالوجی جو مریض کی خدمت کرتی ہے.. اور ڈاکٹر کو بااختیار بناتی ہے',
        intro: 'امان ایور میں ہر کامیاب مشاورت اور آسان بکنگ کے پیچھے، ایک نفیس کنٹرول پینل کھڑا ہے جو احتیاط سے ڈیزائن کیا گیا ہے۔',
        patientColumn: {
          title: 'مریضوں اور کلائنٹس کے لیے 🩺',
          features: []
        },
        doctorColumn: {
          title: 'ڈاکٹروں اور دیکھ بھال فراہم کنندگان کے لیے 💼',
          features: []
        },
        patientCta: 'ایپ ڈاؤن لوڈ کریں اور اپنا علاج کا سفر شروع کریں',
        doctorCta: 'ہمارے نیٹ ورک میں شامل ہوں اور اپنے ڈیجیٹل کلینک کو بڑھائیں'
      },
      error: {
        title: 'معذرت، ایک غیر متوقع خرابی پیش آگئی',
        desc: 'ہمیں فی الحال اس حصے کو لوڈ کرنے میں دشواری ہو رہی ہے۔ براہ کرم دوبارہ کوشش کریں یا صفحہ کو تازہ کریں۔',
