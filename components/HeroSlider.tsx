...
const HeroSlider: React.FC<HeroSliderProps> = ({ onOpenBookings }) => {
  ...
  const slides = [
    ...
    },
    {
      ...
      message: t('hero.slides.3.message'),
      cta: t('hero.slides.3.cta'),
      image: "https://images.unsplash.com/photo-1550005814-498b58df8bba?auto=format&fit=crop&q=80&w=1920",
      color: "from-[#001f1f]/95 via-[#001f1f]/70 to-transparent",
      alt: "Loyalty card management"
    },
    {
              ...
              <div className="container mx-auto px-4 sm:px-6 md:px-12 text-white">
                <div className={`max-w-4xl ${isRtl ? 'text-right' : 'text-left'}`}>
                  ...
                  <motion.p 
                    ...
                    className="text-sm sm:text-xl mb-8 md:mb-12 text-white/70 font-bold italic border-r-4 border-[#4d8080] pr-4"
                  >
